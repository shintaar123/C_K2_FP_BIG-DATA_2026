...
docker compose exec spark-master /opt/spark/bin/spark-submit \
  ...
  /opt/spark/work-dir/app/ml/train_importance.py
"""
...
# ─── Konfigurasi (ubah 3 baris ini untuk membuat urgency classifier) ─────────
TARGET_COL   = "importance_label"
MODEL_OUTPUT = "s3a://mlflow/models/importance_classifier"
EXPERIMENT   = "importance-classifier"
RUN_NAME     = "importance-rf-v1"
...
# handleInvalid="error" supaya label benar-benar 0/1 (tinggi/rendah) -> AUC valid
...
# AUC-ROC sebagai objective CV (metrik utama binary classifier)
